...
MYTOPLING_DATA_DIR=$STORAGE/mytopling-data
TOPLINGDB_INSTALL_DIR=$STORAGE/toplingdb
# type is env var

#export LD_LIBRARY_PATH=${LD_LIBRARY_PATH}:/usr/lib64/
export LD_LIBRARY_PATH=$TOPLINGDB_INSTALL_DIR/lib64/:$TOPLINGDB_INSTALL_DIR/lib/private/:$TOPLINGDB_INSTALL_DIR/lib/mysqlrouter/private:$TOPLINGDB_INSTALL_DIR/lib/mysqlrouter:$MYTOPLING_INSTALL_DIR/lib/mysqlrouter:$MYTOPLING_INSTALL_DIR/lib/mysqlrouter/private:$MYTOPLING_INSTALL_DIR/lib/private
...
$MYTOPLING_INSTALL_DIR/bin/mysqld ${common_args[@]} ${binlog_args[@]} ${innodb_args[@]} ${rocksdb_args[@]} $@
