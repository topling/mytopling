...
export LD_LIBRARY_PATH=/node-shared/mytopling-${type}/lib/mysqlrouter:${LD_LIBRARY_PATH}
...
export TOPLING_SIDEPLUGIN_CONF=${mydir}/mytopling-2nd.json
...
primary_datadir=/nvme-shared/mytopling/datadir
datadir=/nvme-shared/mytopling/datadir-2nd
...
if [ $# -eq 0 ]; then
  rocksdb_args=(--plugin-load=ha_rocksdb_se.so
    ...
    --rocksdb_datadir=${primary_datadir}/.rocksdb
    #--rocksdb_bulk_load
