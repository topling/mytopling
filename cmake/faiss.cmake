...
FIND_LIBRARY(OPENMP_LIBRARY REQUIRED
    NAMES libomp.so.5 libgomp.so.1 libomp.so libgomp.so omp gomp
    HINTS ${WITH_OPENMP}/lib)
IF (WITH_OPENMP)
  SET(Arg_OpenMP_CXX_INCLUDE_DIR "-DOpenMP_CXX_INCLUDE_DIR=${WITH_OPENMP}/include")
ENDIF()
